                ...
                <Sheet open={isOpen} onOpenChange={setIsOpen}>
                    ...
                    <SheetContent className="mb-2">
                        ...
                        <nav className="flex flex-col  space-y-4">
                            <Link onClick={() => setIsOpen(false)} className="hover:underline">new</Link>
                            <Link onClick={() => setIsOpen(false)} className="hover:underline">top</Link>
                            <Link onClick={() => setIsOpen(false)} className="hover:underline">submit</Link>
                            {user ? (<>
                                <span>user: {user}</span>
                                <Button
                                    asChild
